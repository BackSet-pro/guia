...
class EditForKmPage extends StatefulWidget {
  EditForKmPage({Key key, @required this.trainingApi, this.training})
      : super(key: key);
  ...
  @override
  _EditForKmPageState createState() => _EditForKmPageState();
}

class _EditForKmPageState extends State<EditForKmPage> {
      ...
      try {
        ...
        if (allNames.contains(_name)) {
          ...
          final Training training = new Training().copyWith(
            ...
            repetitions: int.parse(_distance),
  ...
  uploadImageToFirebase() {
    final String path = 'for_km/for_km_${DateTime.now().toString()}.jpg';
