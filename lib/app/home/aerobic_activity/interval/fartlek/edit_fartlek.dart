...
class EditFartlekPage extends StatefulWidget {
  EditFartlekPage({Key key, @required this.trainingApi, this.training})
      : super(key: key);
  ...
  static Future<void> show(BuildContext context, {Training training}) async {
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => EditFartlekPage(
  ...
  @override
  _EditFartlekPageState createState() => _EditFartlekPageState();
}

class _EditFartlekPageState extends State<EditFartlekPage> {
  ...
  uploadImageToFirebase() {
    final String path = 'for_km/for_km${DateTime.now().toString()}.jpg';
