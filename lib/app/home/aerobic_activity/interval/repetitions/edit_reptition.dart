...
class EditRepetitionPage extends StatefulWidget {
  EditRepetitionPage({Key key, @required this.trainingApi, this.training})
      : super(key: key);
  ...
  static Future<void> show(BuildContext context, {Training training}) async {
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => EditRepetitionPage(
  ...
  @override
  _EditRepetitionPageState createState() => _EditRepetitionPageState();
}

class _EditRepetitionPageState extends State<EditRepetitionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 2.0,
        title: Text(
            widget.training == null ? 'Nueva Repeticion' : 'Editar Repeticion'),
        actions: <Widget>[
          FlatButton(
            child: Icon(
              Icons.save,
  ...
  uploadImageToFirebase() {
    final String path =
        'repetition/repetition_${DateTime.now().toString()}.jpg';
