...
class DescribeCrossfitPage extends StatefulWidget {
  const DescribeCrossfitPage({Key key, this.training, this.trainingApi})
      : super(key: key);
  ...
  static Future<void> show(BuildContext context, {Training training}) async {
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => DescribeCrossfitPage(
  ...
  @override
  _DescribeCrossfitPageState createState() => _DescribeCrossfitPageState();
}

class _DescribeCrossfitPageState extends State<DescribeCrossfitPage> {
  bool select = false;
