...
class EditPersonalizedPage extends StatefulWidget {
  EditPersonalizedPage({Key key, @required this.trainingApi, this.training})
      : super(key: key);
  ...
  static Future<void> show(BuildContext context, {Training training}) async {
    ...
    await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => EditPersonalizedPage(
  ...
  @override
  _EditPersonalizedPageState createState() => _EditPersonalizedPageState();
}

class _EditPersonalizedPageState extends State<EditPersonalizedPage> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.training == null
            ? 'Nuevo personalizado'.toUpperCase()
            : 'Editar personalizado'.toUpperCase()),
        actions: <Widget>[
          FlatButton(
            child: Icon(
              Icons.save,
  ...
  uploadImageToFirebase() {
    final String path =
        'personalized/personalized_${DateTime.now().toString()}.jpg';
