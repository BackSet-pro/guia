...
class RecreationalActivityPage extends StatelessWidget {
  ...
  Widget _buildContents(BuildContext bodyContext) {
    ...
    return StreamBuilder<List<Training>>(
      stream: trainingApi.recreationalActivityStream(),
      builder: (context, snapshot) {
        return ListItemsBuilder<Training>(
          snapshot: snapshot,
          itemBuilder: (context, training) => Dismissible(
            key: Key('recreational-activities-${training.idtraining}'),
